<?php
session_start();
include_once('filesystem/hconnect.php');
?>
...
<script type="text/javascript" src="filesystem/js/jquery-1.8.3.min.js"></script>

<script type="text/javascript" src="filesystem/js/slider.js"></script>
</head>
...
<div id="header_wrapper">
    <div id="header">
        <?php  include_once 'filesystem/h1.php';?>
...
<div id="menu_wrapper">    
    ...
    <?php include_once 'filesystem/adtab.php'; ?>
    <!-- end of menu -->
...
<div id="content"><!-- end of content left -->
  ...
  <div id="content_right"  style="margin-left:200px; float:none;">
        ...
        <div class="image_wrapper"><img src="filesystem/images/images(4).jpeg" height="60" width="auto" alt="image" /><img src="filesystem/images/images(9).jpeg" height="60" width="auto" alt="xc"><img src="filesystem/images/images(11).jpeg" height="60" width="auto" alt="image" /><img src="filesystem/images/images(13).jpeg" height="60" width="auto" alt="image" /><img src="filesystem/images/images(14).jpeg" height="60" width="auto" alt="image" /></div>
  ...
  <div class="margin_bottom_40 border_bottom">  <a href="filesystem/distributors.php"><img src="images/back.jpg" width="100px" height="25px"></a>  &nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;<a onclick='window.close()'><img src="images/close.jpg"width="100px" height="25px"> </a></div>
...
<?php include_once 'filesystem/footer.php'; session_write_close();?>
