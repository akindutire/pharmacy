...
<div id="content"><!-- end of content left -->
  ...
  <div id="content_right"  style="margin-left:200px; float:none;">
        ...
        <div class="content_right_280_section margin_right_60">
            <div class="content_header_01"><b>Adjust Order</b></div>
        
        <?php
		
        if(isset($_POST['submiti'])){
			$pn=trim(strtoupper(stripslashes($_POST['pn'])));
			
			if(!empty($pn)){
				$_SESSION['pin']=$pn;
				
				header('location:checkpin.php');
			}else{
				$arr['1']='Empty Field';
				}
			}
        ...
        <div class="all"><label>Pin</label><input type="text" name="pn" placeholder="97848GH" onchange="check()" required/></div>
        
        <div class="all"><input type="submit" value="Adjust Order" name="submiti"></div>
        </form>
        <br><br><br>
